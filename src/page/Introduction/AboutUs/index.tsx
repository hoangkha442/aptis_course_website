...
export default function AboutUs({}: Props) {
  return (
    <section className="grid md:grid-cols-2 grid-cols-1 py-6 sm:py-10 md:py-14 gap-4 md:gap-10">
      {/* Text Section */}
      <div>
        <p className="text-customPurple text-xl sm:text-2xl md:text-3xl font-bold uppercase">
          Về chúng tôi
        </p>
        <p className="text-sm sm:text-lg leading-[1.45] text-[#7a7a7a] py-2 sm:py-3 md:py-6">
          Chúng tôi tự hào giới thiệu một nền tảng trực tuyến chuyên cung cấp
          các khóa học chất lượng cao cho mọi người. Với sứ mệnh mang đến tri
          thức và kiến thức hữu ích, chúng tôi hy vọng có thể đóng góp vào việc
          phát triển cá nhân và nghề nghiệp của bạn.
        </p>
